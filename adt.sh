...
env_var "REPOS_LIST" "meeds-io:gatein-wci meeds-io:kernel meeds-io:core meeds-io:ws meeds-io:gatein-sso meeds-io:gatein-pc meeds-io:gatein-portal meeds-io:maven-depmgt-pom meeds-io:platform-ui meeds-io:commons meeds-io:social Meeds-io:analytics meeds-io:gamification meeds-io:poll meeds-io:gamification-github meeds-io:wallet meeds-io:kudos meeds-io:perk-store meeds-io:app-center meeds-io:push-notifications meeds-io:notes Meeds-io:task meeds-io:addons-manager meeds-io:meeds exoplatform:agenda exoplatform:agenda-connectors exoplatform:jcr exoplatform:ecms exoplatform:chat-application exoplatform:data-upgrade exoplatform:digital-workplace exoplatform:layout-management exoplatform:news exoplatform:onlyoffice exoplatform:saml2-addon exoplatform:processes exoplatform:web-conferencing exoplatform:jitsi exoplatform:jitsi-call exoplatform:multifactor-authentication exoplatform:microservices exoplatform:automatic-translation exoplatform:documents exoplatform:dlp exoplatform:mail-integration exoplatform:anti-malware exoplatform:anti-bruteforce exoplatform:platform-private-distributions"
