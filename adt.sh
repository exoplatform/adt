...
env_var "REPOS_LIST" "meeds-io:gatein-dep meeds-io:gatein-wci meeds-io:kernel meeds-io:core meeds-io:ws meeds-io:gatein-sso meeds-io:gatein-pc meeds-io:gatein-portal meeds-io:maven-depmgt-pom meeds-io:platform-ui meeds-io:commons meeds-io:social Meeds-io:analytics meeds-io:gamification meeds-io:poll meeds-io:wallet meeds-io:kudos meeds-io:perk-store meeds-io:app-center meeds-io:exo-es-embedded meeds-io:push-notifications meeds-io:notes meeds-io:challenges Meeds-io:task meeds-io:addons-manager meeds-io:meeds exoplatform:agenda exoplatform:wiki exoplatform:jcr exoplatform:ecms exoplatform:calendar exoplatform:forum exoplatform:cas-addon exoplatform:chat-application exoplatform:data-upgrade exoplatform:digital-workplace exoplatform:layout-management exoplatform:lecko exoplatform:legacy-intranet exoplatform:news exoplatform:onlyoffice exoplatform:openam-addon exoplatform:remote-edit exoplatform:saml2-addon exoplatform:spnego-addon exoplatform:processes exoplatform:wcm-template-pack exoplatform:web-conferencing exoplatform:jitsi exoplatform:jitsi-call exoplatform:multifactor-authentication exoplatform:microservices exoplatform:automatic-translation exoplatform:documents exoplatform:platform-private-distributions"
