                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="ms-1"><?= componentProductHtmlLabel($descriptor_array); ?></span>
                                            </div>
                                            <div class="mt-1">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr> 
                                    ...
                                    <td class="col-center"><span class="badge bg-primary"><?=$servers_counter["acceptance7.exoplatform.org"]['nb']?></span></td> 
                                    ...
                                    <td><small>RAM = 128GB<br />CPU = Xeon E5-1650 v2 @ 3.50GHz (6 cores + hyperthreading = 12 threads)<br />Disks = 3 x 300GB SSD</small></td> 
                                </tr>                
                                <tr>
                                    <td class="col-center">acceptance12.exoplatform.org</td>
                                    <td class="col-center">acc02</td>
                                    <td class="col-center"><span class="badge bg-primary"><?=$servers_counter["acceptance12.exoplatform.org"]['nb']?></span></td>
                                    ...
                                    <td><small>RAM = 128GB<br />CPU = AMD Ryzen 9 5900X @ 3.7GHz/4.8GHz (12 cores + hyperthreading = 24 threads)<br />Disks = 2 x 1.92To NVMe</small></td>
                                </tr>
                                <tr>
                                    <td class="col-center">acceptance13.exoplatform.org</td>
                                    <td class="col-center">acc03</td>
                                    <td class="col-center"><span class="badge bg-primary"><?=$servers_counter["acceptance13.exoplatform.org"]['nb']?></span></td>
                                    ...
                                    <td><small>RAM = 128GB<br />CPU = Xeon E2388G @ 3.2GHz/4.6GHz (8 cores + hyperthreading = 16 threads)<br />Disks = 2 x 960Go NVMe</small></td>
                                </tr>
                                <tr>
                                    <td class="col-center">acceptance14.exoplatform.org</td>
                                    <td class="col-center">acc04</td>
                                    <td class="col-center"><span class="badge bg-primary"><?=$servers_counter["acceptance14.exoplatform.org"]['nb']?></span></td>
                                ...
                                <tr>
                                    ...
                                    <td class="col-center"><span class="badge bg-primary"><?=$servers_counter["acceptance15.exoplatform.org"]['nb']?></span></td>
