...
<html lang="en">
<head>
    <?php pageHeader("Customer Projects"); ?>
</head>
<body>
    <?php pageTracker(); ?>
    <?php pageNavigation(); ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <h1 class="h4 mb-4">Customer Project Environments</h1>
                                <p class="lead">These instances are deployed for <strong>Customer Projects</strong> development Team deployment usage only.</p>
                                
                                <?php if (isDeploymentInCategoryArray($cp_instances)): ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="15" class="category-row">
                                                        <i class="fas fa-briefcase me-2"></i>Customer Projects integration environments
                                                    </td>
                                                </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="float-end">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <a href="https://ci.exoplatform.org/job/platform-enterprise-<?= htmlspecialchars($descriptor_array->PLF_BRANCH) ?>-<?= htmlspecialchars($descriptor_array->INSTANCE_ID) ?>-deploy-acc/build?delay=0sec" 
                                                                           target="_blank" 
                                                                           title="Restart your instance or reset your instance's data" 
                                                                           data-bs-toggle="tooltip">
                                                                            <i class="fas fa-sync-alt"></i>
