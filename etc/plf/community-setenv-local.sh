...
# New Relic
[ -z $NEWRELIC_ENV ] && NEWRELIC_ENV="acceptance"
...
[ -z $EXO_ES_EMBEDDED_HTTP_PORT ] && EXO_ES_EMBEDDED_HTTP_PORT="${DEPLOYMENT_ES_EMBEDDED_HTTP_PORT}"
[ -z $EXO_ES_EMBEDDED_PATH_DATA ] && EXO_ES_EMBEDDED_PATH_DATA="${DEPLOYMENT_ES_EMBEDDED_PATH_DATA}"
