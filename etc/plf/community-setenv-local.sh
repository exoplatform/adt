...
[ -z $EXO_CLOUDDRIVE_SERVICE_SCHEMA ] && EXO_CLOUDDRIVE_SERVICE_SCHEMA="${DEPLOYMENT_CLOUDDRIVE_SERVICE_SCHEMA}"
[ -z $EXO_CLOUDDRIVE_SERVICE_HOST ] && EXO_CLOUDDRIVE_GOOGLE_SERVICE_HOST="${DEPLOYMENT_CLOUDDRIVE_SERVICE_HOST}"
# GOOGLE Drive
[ -z $EXO_CLOUDDRIVE_GOOGLE_CLIENT_ID ] && EXO_CLOUDDRIVE_GOOGLE_CLIENT_ID="${DEPLOYMENT_CLOUDDRIVE_GOOGLE_CLIENT_ID}"
[ -z $EXO_CLOUDDRIVE_GOOGLE_CLIENT_SECRET ] && EXO_CLOUDDRIVE_GOOGLE_CLIENT_SECRET="${DEPLOYMENT_CLOUDDRIVE_GOOGLE_CLIENT_SECRET}"
# DROPBOX Drive
[ -z $EXO_CLOUDDRIVE_DROPBOX_CLIENT_ID ] && EXO_CLOUDDRIVE_DROPBOX_CLIENT_ID="${DEPLOYMENT_CLOUDDRIVE_DROPBOX_CLIENT_ID}"
[ -z $EXO_CLOUDDRIVE_DROPBOX_CLIENT_SECRET ] && EXO_CLOUDDRIVE_DROPBOX_CLIENT_SECRET="${DEPLOYMENT_CLOUDDRIVE_DROPBOX_CLIENT_SECRET}"
# BOX Drive
[ -z $EXO_CLOUDDRIVE_BOX_CLIENT_ID ] && EXO_CLOUDDRIVE_BOX_CLIENT_ID="${DEPLOYMENT_CLOUDDRIVE_BOX_CLIENT_ID}"
[ -z $EXO_CLOUDDRIVE_BOX_CLIENT_SECRET ] && EXO_CLOUDDRIVE_BOX_CLIENT_SECRET="${DEPLOYMENT_CLOUDDRIVE_BOX_CLIENT_SECRET}"
