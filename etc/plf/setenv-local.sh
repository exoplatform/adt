...
# eXo Tomcat
[ -z $DEPLOYMENT_HTTP_PORT ] && DEPLOYMENT_HTTP_PORT="${DEPLOYMENT_HTTP_PORT}"
...
# Matrix
[ -z $DEPLOYMENT_MATRIX_ADMIN_USERNAME ] && DEPLOYMENT_MATRIX_ADMIN_USERNAME="${DEPLOYMENT_MATRIX_ADMIN_USERNAME}"
[ -z $DEPLOYMENT_MATRIX_REGISTRATION_SHARED_KEY ] && DEPLOYMENT_MATRIX_REGISTRATION_SHARED_KEY="${DEPLOYMENT_MATRIX_REGISTRATION_SHARED_KEY}"
[ -z $DEPLOYMENT_MATRIX_JWT_SECRET ] && DEPLOYMENT_MATRIX_JWT_SECRET="${DEPLOYMENT_MATRIX_JWT_SECRET}"
# AI
[ -z $DEPLOYMENT_AI_PORT ] && DEPLOYMENT_AI_PORT="${DEPLOYMENT_AI_PORT}"
# Jitsi
[ -z $DEPLOYMENT_JITSI_EXO_JWT_SECRET ] && DEPLOYMENT_JITSI_EXO_JWT_SECRET="${DEPLOYMENT_JITSI_EXO_JWT_SECRET}"
[ -z $DEPLOYMENT_JITSI_JWT_APP_SECRET ] && DEPLOYMENT_JITSI_JWT_APP_SECRET="${DEPLOYMENT_JITSI_JWT_APP_SECRET}"
# Unpack tomcat wars
[ -z $DEPLOYMENT_TOMCAT_UNPACK_WARS ] && DEPLOYMENT_TOMCAT_UNPACK_WARS=${DEPLOYMENT_TOMCAT_UNPACK_WARS}