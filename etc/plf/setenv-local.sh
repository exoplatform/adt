...
[ -z $DEPLOYMENT_RMI_REG_PORT ] && DEPLOYMENT_RMI_REG_PORT="${DEPLOYMENT_RMI_REG_PORT}"
[ -z $DEPLOYMENT_RMI_SRV_PORT ] && DEPLOYMENT_RMI_SRV_PORT="${DEPLOYMENT_RMI_SRV_PORT}"
# Email
...
# UPLOAD MAX SIZE
[ -z $DEPLOYMENT_UPLOAD_MAX_FILE_SIZE ] && DEPLOYMENT_UPLOAD_MAX_FILE_SIZE=${DEPLOYMENT_UPLOAD_MAX_FILE_SIZE}