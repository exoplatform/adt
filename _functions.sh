...
initialize_product_settings() {
  ...
  case "${ACTION}" in
    ...
    # Mandatory env vars. They need to be defined before launching the script
      ...
      configurable_env_var "DEPLOYMENT_MAILPIT_IMAGE_VERSION" "v1.30.7"
      ...
      configurable_env_var "DEPLOYMENT_FRONTAIL_IMAGE_VERSION" "2.23"
      ...
      configurable_env_var "DEPLOYMENT_CLOUDBEAVER_IMAGE_VERSION" "26.1.5-acc"
