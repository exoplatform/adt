...
initialize_product_settings() {
  ...
  case "${ACTION}" in
    ...
    # Mandatory env vars. They need to be defined before launching the script
      ...
      configurable_env_var "DEPLOYMENT_ADDONS_MANAGER_PATCHES_NOCOMPAT_MODE" "" # used for add-on manager --no-compat parameter (default: none) (possible values: true / false)
